...
@Component({
  ...
  template: `
    ...
    <section>
      @defer (on viewport) {
        <app-comments />
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laudantium dolorum impedit distinctio dolore omnis labore quasi, facilis, quis, nulla enim natus illum consectetur ab ex quidem aliquam facere culpa aspernatur?</p>
      } @placeholder {
        <p>Future comments</p>
      } @loading (minimum 2s) {
